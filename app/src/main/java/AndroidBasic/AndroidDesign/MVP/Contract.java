...
public interface Contract {
    interface View {
        // method to display progress bar when next random course details is being fetched
        void showProgress();

        // method to hide progress bar when next random course details is being fetched
        void hideProgress();

        // method to set random text on the TextView
